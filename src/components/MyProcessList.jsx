...
import {createProcess, deleteMyProcess, nextState} from "../services/myProcess.js";
...
export function MyList ( {workflow}) {
  ...
  function handleDelete(id) {
    ...
    ). then( handleRefreshButton )
    toast.warning('Deleted: id ' + id)
  }

  function handleEdit(id) {
    toast.info('TODO EDIT !!! id -> '+ id );
  }
            ...
            {myProcessList?.map((myProcess) => (
                <tr key={myProcess.id}>
                  ...
                  <td>
                    ...
                    <Button variant="outline-primary" type="button" onClick={ () => handleEdit(myProcess.id)}>
                    ...
                    <Button variant="danger" type="button" onClick={ () => handleDelete(myProcess.id)}>
